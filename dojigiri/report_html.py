...
from .config import ScanReport, Severity, Category
...
def render_html(
  ...
  <td>{html.escape(nist)}</td>
    ...
    findings_html = "\n".join(findings_rows) if findings_rows else "<tr><td colspan='8'>No findings</td></tr>"
...
<table>
<thead>
<tr><th>Severity</th><th>Location</th><th>Rule</th><th>CWE</th><th>Message</th><th>Snippet</th><th>Suggestion</th><th>NIST</th></tr>
</thead>
<tbody>
{findings_html}
</tbody>
...
{cls_footer}
<p class="meta" style="margin-top:24px">Generated by Dojigiri v1.1.0</p>
</body>
</html>"""
