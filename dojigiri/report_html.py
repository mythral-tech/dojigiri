...
<div class="disclaimer" style="margin-top:24px;padding:12px;background:#f8f8f8;border-radius:6px;font-size:12px;color:#666">
  ...
  See <a href="https://github.com/mythral-tech/dojigiri/blob/main/PRIVACY.md">PRIVACY.md</a> for data handling details.
</div>
<p class="meta" style="margin-top:12px">Generated by Dojigiri v{__version__}</p>
</body>
</html>"""
