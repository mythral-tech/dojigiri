...
**Last agent**: Claude
**Date**: 2026-03-03
**What they did**: Package restructure — extracted `wiz/semantic/` (12 modules) and `wiz/graph/` (3 modules) from flat directory. Pure file moves + import rewrites, no functional changes. All 893 tests pass, CLI works, self-scan clean. Updated HANDOFF.md architecture section.

**Previous**: Claude — Sanity check (5 bug fixes, 34 new tests)
