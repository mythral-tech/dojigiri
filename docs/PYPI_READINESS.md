...
| 4 | **LICENSE (AGPL-3.0)** | PASS | File present and correct. AGPL v3 full text from GNU. Licensor: Mythral Technologies Inc. |
...
1. **LICENSE: Edgepoint caveat** -- Resolved. License replaced with AGPL v3 from GNU. Licensor is Mythral Technologies Inc.
